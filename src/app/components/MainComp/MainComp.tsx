...
import TextField from "@mui/material/TextField"; // Updated to MUI v5
import Autocomplete from "@mui/material/Autocomplete"; // Updated to MUI v5
      ...
      <div className="hero-section">
        <div className="hero-content">
          ...
          <div className="search-bar">
            ...
            />
            <button onClick={() => router.push("/forfragan")}>
